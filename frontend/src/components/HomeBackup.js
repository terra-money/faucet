                    ...
                    toast.success(
                        <div>
                            <p>
                                ...
                                {DENUMS_TO_TOKEN[values.denom]} to{' '}
                                {values.address}
                            </p>
                            <a
                                href={url}
        ...
        return (
            <div>
                ...
                <section>
                    ...
                    <article>
                        Hello intrepid spaceperson! Use this faucet to get
                        tokens for the latest Mars testnet. Please don't abuse
                ...
                <section>
                    ...
                    <article>
                        There's two ways to get one. The first is by using
                        Station, the crypto wallet for Terra. If you know
                        command-line-fu, you can also generate an address with
                        the{' '}
